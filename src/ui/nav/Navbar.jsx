      ...
      <div className="w-full flex justify-between items-center">
        ...
        <div className="w-full hidden lg:flex justify-between">
            ...
            {menu.map((nav) => {
              return (
                <a
                  key={nav.path}
                  href={nav.path}
                  className="relative after:w-[0%] hover:after:w-[100%] after:h-[3px] after:absolute hover:after:bg-gray-200 hover:text-gray-200/90 transition after:rounded-xl hover:after:duration-500 after:scale-x-0 hover:after:scale-x-100 after:-bottom-2"
                >
          ...
          <div className="flex space-x-4 justify-end text-sm font-[450]">
            ...
            <a
              href="/quote"
              className="bg-green-600 text-green-50 text-sm font-bold px-5 py-3 hover:text-green-600 hover:bg-green-50 border-2 border-green-600 shadow-lg flex justify-around items-center space-x-3"
            >
