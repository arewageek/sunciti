...
export const RequestQuote = () => {
    ...
    const testimonials = [
        {
            quote: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis quia ratione, adipisci eos, magni ad temporibus autem quibusdam excepturi assumenda doloremque quasi, saepe labore et dolore amet ducimus soluta. Dolorum..",
            client: "Arewa Geek"
        },
        {
            quote: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem iste assumenda cumque beatae facere tempora cum, earum ratione a quia odit corporis. Tempora iure consequuntur veritatis nostrum vel sunt blanditiis.",
            client: "Austin Ameh"
        },
        {
            quote: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi accusantium dolorum repellat sed explicabo maxime animi soluta amet, reprehenderit assumenda, id deserunt labore rem, excepturi dignissimos eum expedita veniam nulla!",
            client: "Ameh Austin"
        }
    ]
            ...
            <div className="w-full bg-green-800 pt-[30pt] pb-10 md:pb-[30pt] md:px-[50pt] md:py-[40pt] text-white">
                <div className="w-full md:w-[80%] px-10 mx-auto flex justify-between items-center flex-col md:flex-row space-y-10 lg:space-y-0">
                                ...
                                <div className="flex space-y-8 flex-col">
                                    <div className="w-full flex flex- md:flex-row space-y-8 md:space-y-0 justify-between">
                                        <div className="w-full lg:w-1/2 md:pr-3">
                                            <label htmlFor="forwho" className="font-bold pb-4 text-sm">
                                                Who will be install system?
                                            </label>

                                            <select type="text" className="text-sm text-gray-800 font-[450] px-6 py-4 rounded border-gray-800/20 bg-white border-2 w-full">
                                        ...
                                        <div className="w-full lg:w-1/2 md:pl-3">
                                            ...
                                            <input type="text" placeholder="(optional)" className="text-sm text-gray-800 font-[450] px-6 py-4 rounded border-gray-800/20 bg-white border-2 w-full" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full flex flex- md:flex-row space-y-8 md:space-y-0 justify-between">
                                        <div className="w-full lg:w-1/2 md:pr-3">
                                            ...
                                            <select type="text" className="text-sm text-gray-800 font-[450] px-6 py-4 rounded border-gray-800/20 bg-white border-2 w-full">
                                                <option className="py-4 px-6 text-gray-800" value="local">Off Grid</option>
                                                <option className="py-4 px-6 text-gray-800" value="foreign">On Grid</option>
                                            </select>
                                        </div>
                                        ...
                                        <div className="w-full lg:w-1/2 md:pl-3">
                                            ...
                                            <select type="text" className="text-sm text-gray-800 font-[450] px-6 py-4 rounded border-gray-800/20 bg-white border-2 w-full">
                                                <option className="py-4 px-6 text-gray-800" value="local">Huge Farm</option>
                                                <option className="py-4 px-6 text-gray-800" value="foreign">Small Farm</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full flex flex- md:flex-row space-y-8 md:space-y-0 justify-between">
                                        <div className="w-full lg:w-1/2 md:pr-3">
                                            ...
                                            <select type="text" className="text-sm text-gray-800 font-[450] px-6 py-4 rounded border-gray-800/20 bg-white border-2 w-full">
                                                <option className="py-4 px-6 text-gray-800" value="local">Comp Shingle</option>
                                                <option className="py-4 px-6 text-gray-800" value="foreign">Roof Shingle</option>
                                            </select>
                                        </div>
                                        ...
                                        <div className="w-full lg:w-1/2 md:pl-3">
                                            ...
                                            <select type="text" className="text-sm text-gray-800 font-[450] px-6 py-4 rounded border-gray-800/20 bg-white border-2 w-full">
                                                <option className="py-4 px-6 text-gray-800" value="local">All</option>
                                                <option className="py-4 px-6 text-gray-800" value="foreign">Email</option>
                                                <option className="py-4 px-6 text-gray-800" value="foreign">Phone</option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div className="w-full lg:w-2/5">
                        ...
                        <div className="h-1 border-t-[1px] border-green-200 w-full my-10">
