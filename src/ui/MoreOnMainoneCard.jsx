          ...
          <div className="text-sm pr-5 lg:pr-10 py-5 flex flex-col space-y-3">
            ...
            <ul className="ml-5">
              {points.map((point) => (
                <li
                  key={point}
                  className="my-2 text-gray-600/90 flex items-center space-x-4"
                >
                  <div>
            ...
            <div className="py-3 w-full p-2">
              <div className="w-fit">
                <a
                  href="#"
                  className="flex space-x-2 hover:space-x-4 px-7 py-4 bg-green-600 hover:bg-green-200 text-green-200 hover:text-green-600 border-2 border-green-600 transition-all duration-500 shadow"
                >
                  <div>Learn More</div>
